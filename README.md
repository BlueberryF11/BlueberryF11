...
## `03` · Marching percussion

Outside of making music on a computer, I'm a **front ensemble percussionist**.

Marching band has become a pretty big part of my life. It gives me a completely different way to think about rhythm, timing, listening, and actually performing music instead of just staring at it inside a DAW.
...
A few things I've built, worked on, or am currently making:

| Project | What it is |
| --- | --- |
| **Blueberry Fruitsy** | My music project, releases, artwork, and everything surrounding it |
| **Artwork Gallery** | A custom gallery for my artwork and visual projects |
| **Image Server** | The backend that stores and serves artwork for the gallery |
...
## `07` · Around the internet

<div align="center">

**Blueberry Fruitsy** · Music & releases  
...
### `BLUEBERRY FRUITSY // SYSTEM STATUS`
